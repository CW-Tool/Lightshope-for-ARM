...
bool GossipHello_TeleportNPC(Player *player, Creature *_Creature)   
{
    ...
    if (player->GetTeam() == HORDE)
    {
        ...
        player->ADD_GOSSIP_ITEM(5, "普通副本"            , GOSSIP_SENDER_MAIN, 5);
        player->ADD_GOSSIP_ITEM(5, "团队副本"                 , GOSSIP_SENDER_MAIN, 101);
        player->ADD_GOSSIP_ITEM(5, "古巴拉什竞技场" , GOSSIP_SENDER_MAIN, 4015);
...
void SendDefaultMenu_TeleportNPC(Player *player, Creature *_Creature, uint32 action)
{
    switch (action)
    {
        ...
        case 5551: // Instances [PAGE 2]
            ...
            player->ADD_GOSSIP_ITEM(5, "沉没的神庙" , GOSSIP_SENDER_MAIN, 1261);
        ...
        case 101: // Raids
            ...
            player->ADD_GOSSIP_ITEM(5, "安其拉神殿" , GOSSIP_SENDER_MAIN, 4005);
...
void Enchant(Player* player, Item* item, uint32 enchantid)
{
    if (!item)
    {
        player->GetSession()->SendNotification("你必须先穿上需要附魔的装备。");
        return;
    }

    if (!enchantid)
    {
        player->GetSession()->SendNotification("出了一点小问题");
        return;
    }
...
bool GossipSelect_EnchantNPC(Player* player, Creature* creature, uint32 sender, uint32 action)
{
    ...
    if (action < 20)
    {
        ...
        case EQUIPMENT_SLOT_CHEST:
            player->ADD_GOSSIP_ITEM(5, "全属性", GOSSIP_SENDER_MAIN, CHEST_STATS);
            break;
        case EQUIPMENT_SLOT_BACK:
            ...
            player->ADD_GOSSIP_ITEM(5, "躲闪", GOSSIP_SENDER_MAIN, CLOAK_DODGE);
        ...
        case EQUIPMENT_SLOT_WRISTS:
            ...
            player->ADD_GOSSIP_ITEM(5, "治疗法术", GOSSIP_SENDER_MAIN, BRACER_HEAL);
        ...
        case EQUIPMENT_SLOT_HANDS:
            ...
            player->ADD_GOSSIP_ITEM(5, "治疗法术", GOSSIP_SENDER_MAIN, GLOVES_HEALING);
            break;
        case EQUIPMENT_SLOT_FEET:
            player->ADD_GOSSIP_ITEM(5, "耐力", GOSSIP_SENDER_MAIN, BOOTS_STAM);
            player->ADD_GOSSIP_ITEM(5, "次级移动速度", GOSSIP_SENDER_MAIN, BOOTS_SPEED);
        ...
        case EQUIPMENT_SLOT_MAINHAND:
            ...
            player->ADD_GOSSIP_ITEM(5, "主手敏捷", GOSSIP_SENDER_MAIN, WEP1H_AGILITY);
            player->ADD_GOSSIP_ITEM(5, "副手敏捷", GOSSIP_SENDER_MAIN, WEP2H_AGILITY);
            player->ADD_GOSSIP_ITEM(5, "法术伤害", GOSSIP_SENDER_MAIN, WEP_SPELLPOWER);
            player->ADD_GOSSIP_ITEM(5, "治疗法术", GOSSIP_SENDER_MAIN, WEP_HEAL);
            break;
    ...
    else
    {
        ...
        switch (action)
        {
            ...
            case OFFHAND_FROSTRES:
                ...
                {
                    player->GetSession()->SendNotification("需要装备盾牌");
                    player->CLOSE_GOSSIP_MENU();
                    return true;
                }
...
bool GossipHello_ProfessionNPC(Player* player, Creature* creature)
{
    ...
    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_2, "草药学",            GOSSIP_SENDER_MAIN, 9);
...
void CompleteLearnProfession(Player *pPlayer, Creature *pCreature, SkillType skill)
{
    ...
    {
        pPlayer->GetSession()->SendNotification("您已经学习了2个主要专业");
    }
    else
    {
